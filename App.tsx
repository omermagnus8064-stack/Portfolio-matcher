      ...
      <aside className="w-full md:w-64 bg-slate-900 text-white flex-shrink-0">
        <div className="p-6 border-b border-slate-800">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-lg tracking-tight">FinanceMatch AI</span>
          </div>
          <p className="text-xs text-slate-400 mt-1">Portfolio Intelligence Ops</p>
        </div>
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium transition-all ${
              currentView === AppView.MATCHES 
                ? 'bg-gradient-to-r from-emerald-600 to-green-600 text-white shadow-lg border border-green-500' 
                : 'text-slate-400 hover:bg-slate-800 hover:text-white'
            }`}
          >
